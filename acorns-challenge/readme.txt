...
The instructions were a little vague, so I interpreted them based upon a logical progression.

The redfin tests are not consistently passing, but that is because of the design of the siter being tested, and there are limitations to capybara and cucumber that can not be adressed in a way that follows the spirit of good testing practices. 

Please let me know when you are done with this and I can make the repository private. My prefrence is to make github code challenges private and then add users to the repos so that other people can't use my code or in this case use my throwaway email adress for their own purposes.
